...
export class BlazStakingHelperV1 extends ethereum.SmartContract {
  static bind(address: Address): BlazStakingHelperV1 {
    return new BlazStakingHelperV1("BlazStakingHelperV1", address);
  }
