...
export class BlazStakingV1__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BlazStakingV1__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class BlazStakingV1 extends ethereum.SmartContract {
  static bind(address: Address): BlazStakingV1 {
    return new BlazStakingV1("BlazStakingV1", address);
  }
  ...
  epoch(): BlazStakingV1__epochResult {
    let result = super.call(
      "epoch",
    ...
    return new BlazStakingV1__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<BlazStakingV1__epochResult> {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint256,uint256)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new BlazStakingV1__epochResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  sBLAZ(): Address {
    let result = super.call("sBLAZ", "sBLAZ():(address)", []);

    return result[0].toAddress();
  }

  try_sBLAZ(): ethereum.CallResult<Address> {
    let result = super.tryCall("sBLAZ", "sBLAZ():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  warmupInfo(param0: Address): BlazStakingV1__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new BlazStakingV1__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<BlazStakingV1__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BlazStakingV1__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
