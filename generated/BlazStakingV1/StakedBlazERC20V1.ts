...
export class StakedBlazERC20V1__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class StakedBlazERC20V1 extends ethereum.SmartContract {
  static bind(address: Address): StakedBlazERC20V1 {
    return new StakedBlazERC20V1("StakedBlazERC20V1", address);
  }
  ...
  rebases(param0: BigInt): StakedBlazERC20V1__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new StakedBlazERC20V1__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(
    param0: BigInt
  ): ethereum.CallResult<StakedBlazERC20V1__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new StakedBlazERC20V1__rebasesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
