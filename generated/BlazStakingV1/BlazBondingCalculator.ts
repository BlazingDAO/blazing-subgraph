...
export class BlazBondingCalculator extends ethereum.SmartContract {
  static bind(address: Address): BlazBondingCalculator {
    return new BlazBondingCalculator("BlazBondingCalculator", address);
  }
