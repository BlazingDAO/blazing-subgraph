...
export class Blaz extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save Blaz entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save Blaz entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("Blaz", id.toString(), this);
  }

  static load(id: string): Blaz | null {
    return store.get("Blaz", id) as Blaz | null;
  }
...
export class BlazBalance extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save BlazBalance entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save BlazBalance entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("BlazBalance", id.toString(), this);
  }

  static load(id: string): BlazBalance | null {
    return store.get("BlazBalance", id) as BlazBalance | null;
  }
  ...
  get blaz(): string {
    let value = this.get("blaz");
    return value.toString();
  }

  set blaz(value: string) {
    this.set("blaz", Value.fromString(value));
  }

  get sBlazBalance(): BigDecimal {
    let value = this.get("sBlazBalance");
    return value.toBigDecimal();
  }

  set sBlazBalance(value: BigDecimal) {
    this.set("sBlazBalance", Value.fromBigDecimal(value));
  }

  get blazBalance(): BigDecimal {
    let value = this.get("blazBalance");
    return value.toBigDecimal();
  }

  set blazBalance(value: BigDecimal) {
    this.set("blazBalance", Value.fromBigDecimal(value));
  }
...
export class Redemption extends Entity {
  ...
  set blaz(value: string | null) {
    if (value === null) {
      this.unset("blaz");
    } else {
      this.set("blaz", Value.fromString(value as string));
    }
  }
...
export class Rebase extends Entity {
  ...
  get stakedBlazs(): BigDecimal {
    let value = this.get("stakedBlazs");
    return value.toBigDecimal();
  }

  set stakedBlazs(value: BigDecimal) {
    this.set("stakedBlazs", Value.fromBigDecimal(value));
  }
...
export class ProtocolMetric extends Entity {
  ...
  get blazCirculatingSupply(): BigDecimal {
    let value = this.get("blazCirculatingSupply");
    return value.toBigDecimal();
  }

  set blazCirculatingSupply(value: BigDecimal) {
    this.set("blazCirculatingSupply", Value.fromBigDecimal(value));
  }

  get sBlazCirculatingSupply(): BigDecimal {
    let value = this.get("sBlazCirculatingSupply");
    return value.toBigDecimal();
  }

  set sBlazCirculatingSupply(value: BigDecimal) {
    this.set("sBlazCirculatingSupply", Value.fromBigDecimal(value));
  }
  ...
  get blazPrice(): BigDecimal {
    let value = this.get("blazPrice");
    return value.toBigDecimal();
  }

  set blazPrice(value: BigDecimal) {
    this.set("blazPrice", Value.fromBigDecimal(value));
  }
  ...
  get nextDistributedBlaz(): BigDecimal {
    let value = this.get("nextDistributedBlaz");
    return value.toBigDecimal();
  }

  set nextDistributedBlaz(value: BigDecimal) {
    this.set("nextDistributedBlaz", Value.fromBigDecimal(value));
  }
  ...
  get treasuryBlazDaiPOL(): BigDecimal {
    let value = this.get("treasuryBlazDaiPOL");
    return value.toBigDecimal();
  }

  set treasuryBlazDaiPOL(value: BigDecimal) {
    this.set("treasuryBlazDaiPOL", Value.fromBigDecimal(value));
  }
...
export class BondDiscount extends Entity {
  ...
  get blazdai_discount(): BigDecimal {
    let value = this.get("blazdai_discount");
    return value.toBigDecimal();
  }

  set blazdai_discount(value: BigDecimal) {
    this.set("blazdai_discount", Value.fromBigDecimal(value));
  }
}
